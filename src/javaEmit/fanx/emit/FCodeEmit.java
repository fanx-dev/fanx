  ...
  private void emitInstructions()
  {
    while (pos < len)
    {
      ...
      switch (opcode)
      {
        ...
        case LoadFieldLiteral:    loadField(); break;
        case LoadMethodLiteral:   loadMethod(); break;
...
//////////////////////////////////////////////////////////////////////////
  ...
  private void loadField() {
	int id = u2();
	FFieldRef ref = pod.fieldRef(id);
	String fieldName = parent.literalField(FTypeEmit.LiteralType.Field, id);
    int fieldRef = emit.field(parent.className + "." + fieldName + ":Lfan/std/Field;");
  ...
  private void loadMethod() {
	int id = u2();
	FMethodRef ref = pod.methodRef(id);  
	String fieldName = parent.literalField(FTypeEmit.LiteralType.Method, id);
    int fieldRef = emit.field(parent.className + "." + fieldName + ":Lfan/std/Method;");
...
//    }
    ...
    String fieldName = parent.literalField(FTypeEmit.LiteralType.Type, ref.id);
