...
**
native abstract rtconst class Type
{
...
//////////////////////////////////////////////////////////////////////////
  ...
  **
  virtual Bool isVal() { flags.and(ConstFlags.Struct) != 0 }
...
//////////////////////////////////////////////////////////////////////////
  ...
  **
  Bool isClass() { flags.and(ConstFlags.Mixin) == 0 }
  ...
  **
  Bool isEnum() { flags.and(ConstFlags.Enum) != 0 }

  **
  ** Return if this Type is an Facet type.
  **
  Bool isFacet() { flags.and(ConstFlags.Facet) != 0 }

  **
  ** Return if this Type is marked final which means it may not be subclassed.
  **
  Bool isFinal() { flags.and(ConstFlags.Final) != 0 }
  ...
  **
  Bool isMixin() { flags.and(ConstFlags.Mixin) != 0 }
...
//////////////////////////////////////////////////////////////////////////
  ...
  **   OutStream#.base  =>  sys::Obj
  **
  override Type? base() { initInheritance; return _base }
  ...
  **   OutStream#.mixins  =>  [,]
  **
  override Type[] mixins() { initInheritance; return _mixins }
  ...
  **   Int#.inheritance  =>  [sys::Int, sys::Num, sys::Obj]
  **
  override Type[] inheritance() { initInheritance; return _inheritance }
...
//////////////////////////////////////////////////////////////////////////
  ...
  ** List of the all defined fields (including inherited fields).
  **
  override Field[] fields() { init; return _fields }

  **
  ** List of the all defined methods (including inherited methods).
  **
  override Method[] methods() { init; return _methods }

  **
  ** List of the all defined slots, both fields and methods (including
  ** inherited slots).
  **
  override Slot[] slots() { init; return _slots }
  ...
  **
  override Slot? slot(Str name, Bool checked := true) {
    init
    return slotMap.getChecked(name, checked)
  }
...
//////////////////////////////////////////////////////////////////////////
  ...
  internal Void addFacet(Str type, Str val) {
    init
    return _facets.addFacet(type, val)
  }
  ...
  ** See [Facets Doc]`docLang::Facets` for details.
  **
  override Facet[] facets() { init; return _facets.facets }
  ...
  **
  override Facet? facet(Type type, Bool checked := true) {
    init
    return _facets.getFacet(type, checked)
  }
