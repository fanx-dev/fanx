...
//////////////////////////////////////////////////////////////////////////
  ...
  override Void visitTypeDef(TypeDef t)
  {
    ...
    if (t.slotDef("typeof") != null && t.qname != "sys::Obj" && t.qname != "reflect::Type" /*&& !isSys*/)
...
//////////////////////////////////////////////////////////////////////////
  ...
  private Void checkInstanceCtor(MethodDef m)
  {
    ...
    if (m.ctorChain == null && /*!compiler.isSys &&*/ curType.base != null && !curType.base.isObj && !curType.isSynthetic)
