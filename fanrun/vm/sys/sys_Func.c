...
fr_Obj sys_BindFunc_call__0_f(fr_Env env, fr_Obj self) {
    fr_Value args[2];
    args[0].i = 10;
...
fr_Obj sys_BindFunc_call__1_f(fr_Env env, fr_Obj self, fr_Obj a) {
    fr_Value args[2];
    args[0].i = 10;
    fr_newObjS(env, "sys", "List", "make", 1, args, args+1);
...
fr_Obj sys_BindFunc_call__2_f(fr_Env env, fr_Obj self, fr_Obj a, fr_Obj b) {
    fr_Value args[2];
    args[0].i = 10;
    fr_newObjS(env, "sys", "List", "make", 1, args, args+1);
...
fr_Obj sys_BindFunc_call__3_f(fr_Env env, fr_Obj self, fr_Obj a, fr_Obj b, fr_Obj c) {
    fr_Value args[2];
    args[0].i = 10;
    fr_newObjS(env, "sys", "List", "make", 1, args, args+1);
...
fr_Obj sys_BindFunc_call__4_f(fr_Env env, fr_Obj self, fr_Obj a, fr_Obj b, fr_Obj c, fr_Obj d) {
    fr_Value args[2];
    args[0].i = 10;
    fr_newObjS(env, "sys", "List", "make", 1, args, args+1);
...
fr_Obj sys_BindFunc_call__5_f(fr_Env env, fr_Obj self, fr_Obj a, fr_Obj b, fr_Obj c, fr_Obj d, fr_Obj e) {
    fr_Value args[2];
    args[0].i = 10;
    fr_newObjS(env, "sys", "List", "make", 1, args, args+1);
...
fr_Obj sys_BindFunc_call__6_f(fr_Env env, fr_Obj self, fr_Obj a, fr_Obj b, fr_Obj c, fr_Obj d, fr_Obj e, fr_Obj f) {
    fr_Value args[2];
    args[0].i = 10;
    fr_newObjS(env, "sys", "List", "make", 1, args, args+1);
...
fr_Obj sys_BindFunc_call__7_f(fr_Env env, fr_Obj self, fr_Obj a, fr_Obj b, fr_Obj c, fr_Obj d, fr_Obj e, fr_Obj f, fr_Obj g) {
    fr_Value args[2];
    args[0].i = 10;
    fr_newObjS(env, "sys", "List", "make", 1, args, args+1);
