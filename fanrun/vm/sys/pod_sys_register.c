...
void sys_register(fr_Fvm vm) {
    ...
    fr_registerMethod(vm, "sys_Bool_not", sys_Bool_not_v);
    fr_registerMethod(vm, "sys_Bool_and", sys_Bool_and_v);
    fr_registerMethod(vm, "sys_Bool_or", sys_Bool_or_v);
    fr_registerMethod(vm, "sys_Bool_xor", sys_Bool_xor_v);
    ...
    fr_registerMethod(vm, "sys_Int_not", sys_Int_not_v);
    fr_registerMethod(vm, "sys_Int_and", sys_Int_and_v);
    fr_registerMethod(vm, "sys_Int_or", sys_Int_or_v);
    fr_registerMethod(vm, "sys_Int_xor", sys_Int_xor_v);
