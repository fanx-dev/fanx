...
void std_Regex_init(fr_Env __env, std_Regex_ref __self) { FR_SET_ERROR_ALLOC(sys_UnsupportedErr); }
sys_Bool std_Regex_matches(fr_Env __env, std_Regex_ref __self, sys_Str s) { FR_SET_ERROR_ALLOC(sys_UnsupportedErr); return 0; }
std_RegexMatcher std_Regex_matcher(fr_Env __env, std_Regex_ref __self, sys_Str s) { FR_SET_ERROR_ALLOC(sys_UnsupportedErr); return 0; }
...
void std_RegexMatcher_make(fr_Env __env, std_RegexMatcher_ref __self) { FR_SET_ERROR_ALLOC(sys_UnsupportedErr); }
sys_Bool std_RegexMatcher_matches(fr_Env __env, std_RegexMatcher_ref __self) { FR_SET_ERROR_ALLOC(sys_UnsupportedErr); return 0; }
